 ...
 * var Struct = require('mt-node-ref-struct')
 *
...
function recalc(struct) {
  ...
  fieldNames.forEach(function (name) {
    ...
    if (null != type.fixedLength) {
      // mt-node-ref-array types set the "fixedLength" prop. don't treat arrays like one
